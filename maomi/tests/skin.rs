...
fn component_class_prefix() {
    assert_eq!(<SkinStatic as ComponentTemplate<Empty>>::template_skin(), r#".SKIN_STATIC-a{color:red;transform:translateZ(0)}"#);
...
#[test]
fn skin_set() {
    assert_eq!(SKIN_SET, r#".SKIN_SET-a{border:0px 1px;padding:0px 1px;color:red}"#);
}
...
#[test]
fn skin_import() {
    assert_eq!(SKIN_IMPORT, r#".SKIN_IMPORT-global{color:blue}.SKIN_IMPORT-a{color:red;margin:1px 0px}"#);
}
